            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        path: 'articles',
                        name: 'ArticleList',
                        component: () => import(/* webpackChunkName: "article" */ '@/features/article/views/ArticleList.vue'),
                        meta: {
                            title: 'Articles'
                        }
                    },
                    {
                        ...
                        name: 'ArticleDetail',
                        component: () => import(/* webpackChunkName: "article" */ '@/features/article/views/ArticleDetail.vue'),
                        props: true
                    },
                    {
                        path: 'login',
